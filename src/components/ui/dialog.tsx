...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & { disableAutoFocus?: boolean }
>(({ className, children, disableAutoFocus, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
